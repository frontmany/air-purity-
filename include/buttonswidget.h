...
private:
	QString style1 = "QPushButton {color:rgb(248, 249, 249); background-color:rgb(56, 56, 56); border-radius: 5px; border:rgb(26, 26, 26); padding: 10px 20px; font-size: 14px;font-weight: 400;}"
